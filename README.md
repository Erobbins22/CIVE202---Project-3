...
### 1. Program Overview
This system automates the generation of five specific transportation-related visualizations and mathematical simulation of car following behavior. The code is designed to provide the transportation planning group with a quick analysis of US travel trends. 
...
- At least one plot uses advanced Matplotlib or Seaborn features, including custom color palettes, font adjustments, and labeled lengends to meet FHWA reporting standards. 
